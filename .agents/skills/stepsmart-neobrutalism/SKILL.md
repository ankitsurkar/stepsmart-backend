---
name: stepsmart-neobrutalism
description: Design system guidelines, Tailwind CSS tokens, component patterns, and post templates for StepSmart's Neobrutalism aesthetic. Use when creating landing pages, posts, banners, resource cards, social media graphics, or UI components to ensure visual consistency with StepSmart.
---

# StepSmart Neobrutalism Design Guidelines
