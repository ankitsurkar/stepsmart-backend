    ...
    <div className="min-h-screen bg-[#FFFFFF] font-sans text-[#111111] selection:bg-[#188ab2]/30">
      ...
      <div className="fixed top-0 z-50 w-full flex flex-col">
        ...
        {isMenuOpen && (
          <div className="md:hidden w-full bg-[#FFFFFF] border-b-[3px] border-[#111111] p-6 flex flex-col gap-4 shadow-[4px_4px_0px_0px_rgba(17,17,17,1)]">
            ...
            <a href="https://wa.me/919920803517?text=Hi%2C%20I%27m%20interested%20in%20PM-X%20%E2%80%94%20here%27s%20my%20background%3A" target="_blank" rel="noreferrer" onClick={() => setIsMenuOpen(false)} className="font-extrabold text-lg py-2 border-b-2 border-slate-200">Chat 1:1</a>
      ...
      <section className="pt-32 pb-8 bg-[#FFFFFF] border-b-[3px] border-[#111111]">
        <div className="container mx-auto px-6 text-center max-w-[1600px]">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-[1.2] text-[#111111]">
          ...
          <p className="text-base md:text-lg font-bold text-slate-700 max-w-3xl mx-auto leading-relaxed mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-16 mb-16 text-left">
            ...
            <div>
              ...
              <ul className="space-y-4 text-[#111111] text-sm font-bold">
                ...
                <li><Link to="/resources" className="hover:underline decoration-2 decoration-[#188ab2] underline-offset-4">Resources</Link></li>
              </ul>
            </div>
            <div>
