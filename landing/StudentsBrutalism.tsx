      ...
      <div className="fixed top-0 z-50 w-full flex flex-col">
        ...
        {isMenuOpen && (
          <div className="md:hidden w-full bg-[#FFFFFF] border-b-[3px] border-[#111111] p-6 flex flex-col gap-4 shadow-[4px_4px_0px_0px_rgba(17,17,17,1)]">
            ...
            <a href="https://wa.me/message/GH5C7YLAYIEHN1" target="_blank" rel="noreferrer" onClick={() => setIsMenuOpen(false)} className="font-extrabold text-lg py-2 border-b-2 border-slate-200">Chat 1:1</a>
